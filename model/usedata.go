...
func GetQuotaDataByUsernameAndModel(username string, startTime int64, endTime int64, modelName string) (quotaData []*QuotaData, err error) {
	...
	return quotaDatas, query.Find(&quotaDatas).Error
}
...
func GetQuotaDataByUserIdAndModel(userId int, startTime int64, endTime int64, modelName string) (quotaData []*QuotaData, err error) {
	var quotaDatas []*QuotaData
	query := DB.Table("quota_data").
		Select("user_id, username, model_name, created_at, sum(count) as count, sum(quota) as quota, sum(token_used) as token_used").
...
func GetAllQuotaDates(startTime int64, endTime int64, username string) (quotaData []*QuotaData, err error) {
	return GetAllQuotaDatesWithModel(startTime, endTime, username, "")
}

func GetAllQuotaDatesWithModel(startTime int64, endTime int64, username string, modelName string) (quotaData []*QuotaData, err error) {
	if username != "" {
		return GetQuotaDataByUsernameAndModel(username, startTime, endTime, modelName)
	}
	var quotaDatas []*QuotaData
	// 从quota_data表中查询数据
